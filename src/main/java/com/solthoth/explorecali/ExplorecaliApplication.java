package com.solthoth.explorecali;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.solthoth.explorecali.models.Difficulty;
import com.solthoth.explorecali.models.Region;
import com.solthoth.explorecali.services.TourPackageService;
import com.solthoth.explorecali.services.TourService;
...
public class ExplorecaliApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		createTourPackages();
		var numOfPackages = tourPackageService.total();

		createTours("ExploreCalifornia.json");
		var numOfTours = tourService.total();
	}
